...
// only keeping this around as a reference for how it was synchronized

public class XXXDisplay extends JComponent implements BufferObserver, StickyScrollable {
	...
	public XXXDisplay(Buffer buffer, SoftFont font, int columns, int rows) {
		this(buffer, font, columns, rows, true);
	}
	
	public XXXDisplay(Buffer buffer, SoftFont font, int columns, int rows, boolean blink) {
		this.buffer = buffer;
